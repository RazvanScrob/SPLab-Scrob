...
abstract class AlignmentStrategy {
    abstract String align(String text);
}

// Define a concrete subclass for left alignment
class LeftAlign extends AlignmentStrategy {
    @Override
...
// Define a concrete subclass for right alignment
class RightAlign extends AlignmentStrategy {
    @Override
    String align(String text) {
        return String.format("%" + (text.length() + 4) + "s", text);
    }
}
